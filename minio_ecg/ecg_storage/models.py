...
class patients(models.Model):
    ...
    birthdate = models.DateField(help_text="Дата рождения", null=True, blank = True)
    name = models.CharField(max_length=50, help_text="Имя", null=True, blank = True)
    last_name = models.CharField(max_length=50, help_text="Фамилия", null=True, blank = True)
    middle_name = models.CharField(max_length=50, help_text="Отчество", null=True, blank = True)

    class Meta:
        ordering = ["-birthdate"]

class cardiac_pathology(models.Model):
    name = models.CharField(max_length=100, unique=True, help_text="Название патологии")
    short_name = models.CharField(max_length=20, help_text="Короткое название", null=True, blank = True)
...
class ecg(models.Model):
    ...
    access_id = models.ForeignKey(access_groups, models.SET_NULL, blank=True, null=True, help_text="Группа доступа к которой принадлежит экг")
    org_id = models.ForeignKey(source_org, models.SET_NULL, blank=True, null=True, help_text="Организация от которой получено экг")
...
class ecg_files(models.Model):
    ...
    format = models.CharField(max_length=20, help_text="Тип файла", null=True, blank = True)
    file_name = models.CharField(max_length=1024, unique=True, help_text="Имя объекта в MinIo")
...
class conclusion_pathology(models.Model):
    ...
    pathology_id = models.ForeignKey(cardiac_pathology, on_delete=models.CASCADE)